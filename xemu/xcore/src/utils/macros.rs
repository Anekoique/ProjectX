...
macro_rules! rv_inst_table {
    ($macro:ident) => {
        $macro! {
            ...
            (I, (rd, rs1, imm), [addi, addiw, slli, slliw, slti, sltiu, xori, srli, srliw, srai, sraiw, ori, andi, lb, lh, lw, ld, lbu, lhu, lwu, jalr, csrrw, csrrs, csrrc, csrrwi, csrrsi, csrrci, ebreak, ecall, fence, fence_i, wfi]),
