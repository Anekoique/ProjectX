...
> CI/CD pipeline definition — stages, jobs, dependencies, caching.
>
> **Source:** [`/docs/archived/feat/cicd/CICD.md`](/docs/archived/feat/cicd/CICD.md) —
> preserved verbatim as the authoritative spec. Rewrite to the
> template shape when the pipeline next sees meaningful iteration.
