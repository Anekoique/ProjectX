...
> Source: [`/docs/archived/feat/devices/DEV_PLAN.md`](/docs/archived/feat/devices/DEV_PLAN.md)
> (post-iteration final summary, amended with UART TX-default /
> opt-in TCP RX from round 05). Iteration history and per-round
> REVIEW/MASTER artifacts live under `docs/archived/feat/devices/`.
